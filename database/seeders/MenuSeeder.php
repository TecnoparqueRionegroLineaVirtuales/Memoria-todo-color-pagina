...
class MenuSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $rutaCultural->route = "culturalRoute";
        ...
        $customSale = new Menu();
        $customSale->title = "Venta personalizada";
        $customSale->route = "personalizedSaleCreate";
        $customSale->state_id = 1;
        $customSale->menu_type_id = 1;
        $customSale->save();
